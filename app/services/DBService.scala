...
class DBService @Inject()(dao: DAO) {
  ...
  def addFolder(parentId: String, groupId: Int, userId:Int, name: String): Boolean = dao.create(FoldersRow(uuid, parentId, groupId, name, userId, nowTimestamp, userId, nowTimestamp))

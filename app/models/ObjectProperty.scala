...
case class ObjectProperty(`type`: String, id: String, parentId: String, name: String, groupId: String, insertedBy: Int, insertedAt: String, updatedBy: Int, updatedAt: String) {
  ...
  override def equals(other: Any) = other match {
    case that: ObjectProperty =>
      ...
      updatedBy == that.updatedBy && updatedAt == that.updatedAt
    case _ => false
  }
}
